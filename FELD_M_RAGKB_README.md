...
```bash
0 * * * * /bin/bash -l -c "/home/feld/repos/ragkb/build/workstation/deployment_job.sh -b feld-m-main-ragkb -d /home/feld/repos/ragkb/ >> /home/feld/repos/ragkb/build/workstation/logs/deployment_job.log 2>&1"
```
